...
(cl:defmethod cl:initialize-instance :after ((m <Header>) cl:&rest args)
  ...
  (cl:unless (cl:typep m 'Header)
    (roslisp-msg-protocol:msg-deprecation-warning "using old message class name HMCL_V2X-msg:<Header> is deprecated: use HMCL_V2X-msg:Header instead.")))

(cl:ensure-generic-function 'seq-val :lambda-list '(m))
(cl:defmethod seq-val ((m <Header>))
  (roslisp-msg-protocol:msg-deprecation-warning "Using old-style slot reader HMCL_V2X-msg:seq-val is deprecated.  Use HMCL_V2X-msg:seq instead.")
  (seq m))
...
(cl:defmethod frame_id-val ((m <Header>))
  (roslisp-msg-protocol:msg-deprecation-warning "Using old-style slot reader HMCL_V2X-msg:frame_id-val is deprecated.  Use HMCL_V2X-msg:frame_id instead.")
  (frame_id m))
