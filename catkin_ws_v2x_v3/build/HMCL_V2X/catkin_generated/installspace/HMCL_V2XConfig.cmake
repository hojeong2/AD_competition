...
if(NOT "include " STREQUAL " ")
  ...
  foreach(idir ${_include_dirs})
    ...
    elseif("${idir} " STREQUAL "include ")
      ...
      message(FATAL_ERROR "Project 'HMCL_V2X' specifies '${idir}' as an include dir, which is not found.  It does neither exist as an absolute directory nor in '\${prefix}/${idir}'.  ${_report}")
    endif()
...
foreach(library ${libraries})
  ...
  elseif(IS_ABSOLUTE ${library})
    ...
    foreach(path /home/pathcmd/Desktop/Git/AD/catkin_ws_v2x_v2/install/lib;/home/pathcmd/Desktop/Git/AD/catkin_ws_v2x_v1/devel/lib;/home/pathcmd/ros_logger/devel/lib;/opt/ros/noetic/lib)
